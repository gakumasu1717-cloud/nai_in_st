 ...
 * 카드가 데스크톱에서 200px 넘게 나오므로 320px/0.85 정도는 되어야 뭉개지지 않는다.
 * (장당 30~50KB. 설정 파일이 커지는 대신 목록이 또렷해진다)
 */
export async function makeThumbnail(source, maxSize = 320, quality = 0.85) {
